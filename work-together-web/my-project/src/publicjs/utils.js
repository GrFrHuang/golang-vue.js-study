...
let util = {
  ...
  onBuildGetParams(params){
    ...
    for (let key in params) {
      if (encodeURIComponent(params[key]) != '' && encodeURIComponent(params[key]) !== 'bin') {
        result += encodeURIComponent(";" + key) + ":" + encodeURIComponent(params[key])
      }
    }
    return result.substr(3)
  },
  onBuildGetParamsa(params){
    if (typeof params == "string") {
      return params
    }
    if (!params) {
    ...
    for (let key in params) {
      if (encodeURIComponent(params[key]) != '' && encodeURIComponent(key) != 'Qq' && encodeURIComponent(key) != 'Status' && encodeURIComponent(key) != 'QqRechargeStatus' && encodeURIComponent(key) != 'GameRechargeStatus') {
        result += ";" + encodeURIComponent(key) + ":>=" + encodeURIComponent(params[key])
      } else if (encodeURIComponent(params[key]) != '' && encodeURIComponent(key) == 'Qq'){
        result += ";" + encodeURIComponent(key) + ":" + encodeURIComponent(params[key])
      } else if (encodeURIComponent(params[key]) != '' && encodeURIComponent(key) == 'Status'){
        result += ";" + encodeURIComponent(key) + ":" + encodeURIComponent(params[key])
      } else if (encodeURIComponent(params[key]) != '' && encodeURIComponent(key) == 'QqRechargeStatus'){
        result += ";" + encodeURIComponent(key) + ":" + encodeURIComponent(params[key])
      } else if (encodeURIComponent(params[key]) != '' && encodeURIComponent(key) == 'GameRechargeStatus'){
        result += ";" + encodeURIComponent(key) + ":" + encodeURIComponent(params[key])
      }
    }
    return result.substr(1)
