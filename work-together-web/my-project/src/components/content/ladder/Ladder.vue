        ...
        <div class="col-md-4">
          ...
          <div class="input-group">
            <input
              ...
              v-model.number="ladder.ratio" :disabled="readonly"
              @change="updateValue">
        ...
        <div class="col-md-4">
          ...
          <div class="input-group">
            <input
              ...
              v-model.number="ladder.slottingFee" :disabled="readonly"
              @change="updateValue">
            <div class="input-group-addon">%</div>
          </div>
        </div>
    ...
    <el-dialog title="添加规则" v-model="isShowAddRuleBox" size="small" :modal="false" :modal-append-to-body="true">
      <el-tabs v-model="addRuleBox.type">
        <el-tab-pane label="金额" name="money">
          <el-row :gutter="24">
            <el-col :span="9">
              <el-input v-model="addRuleBox.moneyBegin" placeholder="请输入内容"></el-input>
            </el-col>
            <el-col :span="1">~</el-col>
            <el-col :span="10">
              <el-input v-model="addRuleBox.moneyEnd" placeholder="请输入内容"></el-input>
        ...
        <el-tab-pane label="用户" name="user">
          <el-row :gutter="24">
            <el-col :span="12">
              <el-input v-model="addRuleBox.userBegin" placeholder="请输入内容"></el-input>
            </el-col>
            <el-col :span="12">
              <el-input v-model="addRuleBox.userEnd" placeholder="请输入内容"></el-input>
            </el-col>
          </el-row>
        </el-tab-pane>
      </el-tabs>
...
//            slotting_fee: parseFloat(ladder.slottingFee / 100).toFixed(4).toString()
            slotting_fee: parseFloat((ladder.slottingFee / 100).toFixed(4)),
            ratio: parseFloat((ladder.ratio / 100).toFixed(4)),
          })
        }
        return temp
      },
    ...
    watch: {
      ...
      defaultTime(n, o){
        ...
        for (let i in this.ladders) {
          ...
          let checkEnd = false
          if(o){
            checkStart = util.checkSameDay(this.ladders[i].time[0], o[0])
            checkEnd = util.checkSameDay(this.ladders[i].time[1], o[1])
          }
