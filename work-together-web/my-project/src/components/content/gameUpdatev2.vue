<template>
  <div>
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="box-body">
            ...
            <el-table
              ...
              <el-table-column
                ...
                <template scope="scope">
                  <p class="max_widths">
                    ...
                    <el-button v-else type="primary" @click="showmaterial(scope.row.game.game_name, scope.row.material)">查看</el-button>
                    <!--<span v-else>查看</span>-->
                  </p>
                </template>
              </el-table-column>
              <el-table-column
                ...
                <template scope="scope">
                  <p class="max_widths">
                    ...
                    <el-button v-else type="primary" @click="showIcon(scope.row.game.game_name, scope.row.icon)">查看</el-button>
                  </p>
                </template>
              </el-table-column>
              <el-table-column
              ...
              <el-table-column
                ...
                <template scope="scope">
                  ...
                  <a class="fa fa-edit" @click="editPreOperation(scope.row)" title="编辑"></a>
                </template>
              </el-table-column>
            </el-table>
            ...
            <el-dialog :title="materialGameName + '---素材预览'" v-model="materialDialogTableVisible" size="tiny">
              <el-carousel height="39vh">
                <el-carousel-item v-for="item in materials">
                  <img :src="item"/>
                </el-carousel-item>
              </el-carousel>
            </el-dialog>
    ...
    <el-dialog
      ...
      <addUpdate :isShowAddForm="isShowAddForm" @close="onEditClose"></addUpdate>
    </el-dialog>
    <el-dialog
      :title="readonly?'查看游戏更新':'编辑游戏更新'"
      v-model="isShowEditForm"
      top="5%"
      size="small"
      :close-on-click-modal="false">
      <editUpdate :rand="rand" :editId="editId" :readonly="readonly" @close="onEditClose"></editUpdate>
    </el-dialog>
  </div>
</template>
<style>
...
<script>
  ...
  import editUpdatev2 from './editUpdatev2.vue'
  ...
  export default {
    ...
    data: function () {
      return {
        ...
        materialDialogTableVisible: false,
        gridData: [],
        gameName: "",
        iconGameName: "",
        materialGameName: "",
    ...
    methods: {
      ...
      showmaterial: function (name, material) {
        this.materials = []
        this.materialGameName = name
        let materials = JSON.parse(material)
        for(let i in materials){
          this.materials.push(utils.buildFileUrl(materials[i]))
        }
        this.materialDialogTableVisible = true
      },
      addUpdate: function() {
        this.readonly = false
