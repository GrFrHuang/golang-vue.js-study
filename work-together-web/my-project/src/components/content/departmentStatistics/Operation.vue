  ...
  <div class="minChartsd">
    ...
    <el-row :gutter="24">
      <el-col :span="22">
        ...
        <chart :options="polarOperation" ref="chart"></chart>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      ChartRequest () {
        let url = ENV.HOST_URL + "/statistic/operation"
        ...
        this.$http.get(url)
          .then((res) => {
            ...
            this.items= []
            this.agreed_game= []
            this.not_agreed_game= []
            this.papare= []
            for( let i in datas) {
              this.items.push(datas[i].date)
              this.agreed_game.push(datas[i].agreed_game)
              this.not_agreed_game.push(datas[i].not_agreed_game)
              this.papare.push(datas[i].papare)
            }
            this.polarSettlements ()
      ...
      polarSettlements () {
        this.polarOperation = {
          ...
          series: [{
            ...
            type: 'line',
            smooth: true,
            data: this.agreed_game
          }, {
            name: '未通过游戏',
            type: 'line',
            smooth: true,
            data: this.not_agreed_game
          }, {
            name: '运营准备',
            type: 'line',
            smooth: true,
