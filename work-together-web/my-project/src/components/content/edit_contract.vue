    ...
    <div class="content">
      <div class="box">
        <div class="box-header with-border">
          <div class="box-title">修改游戏合同</div>
        </div>
        <div class="box-body form-horizontal">
          ...
          <div class="form-group ">
            <label class="col-md-2 control-label">CP商</label>
            <div class="col-md-8">
              <input class="form-control" :value=" mapinfo.issue?mapinfo.issue.name:'' " readonly/>
            </div>
          </div>
          ...
          <div class="form-group ">
            ...
            <div class="col-md-8">
              <!--<multiselect v-model="selectedBodyMy" :options="bodyMy" placeholder="请选择"-->
          ...
          <div class="form-group ">
            ...
            <div class="col-md-8">
              <textarea class="form-control" rows="3" placeholder="请备注 ..." v-model="mapinfo.desc"></textarea>
            </div>
          </div>
          ...
          <div class="form-group ">
            ...
            <div class="col-md-8">
              ...
              <button class="btn btn-default" @click="routerBack">返回</button>
            </div>
          </div>
